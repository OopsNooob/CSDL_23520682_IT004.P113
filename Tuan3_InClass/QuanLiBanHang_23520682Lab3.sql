...
WHERE NUOCSX = 'Trung Quoc'
UNION
SELECT SANPHAM.MASP,TENSP FROM SANPHAM JOIN CTHD ON SANPHAM.MASP = CTHD.MASP JOIN HOADON ON HOADON.SOHD = CTHD.SOHD
WHERE NGHD = '1/1/2007'

-- 15. In ra danh sách các sản phẩm (MASP,TENSP) không bán được.
SELECT MASP, TENSP FROM SANPHAM
EXCEPT
SELECT SANPHAM.MASP, TENSP FROM SANPHAM JOIN CTHD ON SANPHAM.MASP = CTHD.MASP
...
SELECT HOADON.SOHD, HOADON.NGHD FROM HOADON JOIN InvoicesAllSingaporeProducts ON HOADON.SOHD = InvoicesAllSingaporeProducts.SOHD
WHERE NGHD = '2006'